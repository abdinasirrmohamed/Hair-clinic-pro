...
<section class="form-panel">
    <form method="post" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label">Qualification</label><input class="form-control" name="qualification" value="<?= e($_POST['qualification'] ?? '') ?>"></div>
        <div class="col-md-3"><label class="form-label">Experience Years</label><input class="form-control" type="number" name="experience_years" value="<?= e($_POST['experience_years'] ?? '0') ?>"></div>
        ...
        <div class="col-12"><label class="form-label">Availability Schedule</label><textarea class="form-control" name="availability_schedule" rows="3"><?= e($_POST['availability_schedule'] ?? '') ?></textarea></div>
        <div class="col-12"><label class="form-label">Doctor Bio</label><textarea class="form-control" name="bio" rows="3"><?= e($_POST['bio'] ?? '') ?></textarea></div>
