...
<div class="patient-head">
    ...
    <a class="add-patient-btn" href="medicine_add.php"><i class="bi bi-plus-lg"></i>Add Medicine</a>
</div>
...
<section class="patient-management-card">
    <div class="patient-tabs"><div class="tab-links"><a class="active" href="medicines.php">Medicines</a><a href="sale.php">New Sale</a><a href="reports.php">Reports</a></div></div>
    ...
    <?php foreach ($medicines as $medicine): ?>
        <div class="patient-list-grid patient-list-row" style="grid-template-columns: 1.4fr 1fr .7fr .8fr .9fr 1fr .7fr;">
            ...
            <span class="patient-actions"><a href="medicine_edit.php?id=<?= $medicine['id'] ?>"><i class="bi bi-pencil-square"></i></a><a href="medicine_delete.php?id=<?= $medicine['id'] ?>" onclick="return confirm('Delete medicine?')"><i class="bi bi-trash"></i></a></span>
        </div>
    <?php endforeach; ?>
