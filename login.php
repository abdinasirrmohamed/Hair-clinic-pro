...
<head>
    ...
    <title>Sign in â€” Hair Clinic Pro</title>
    <meta name="description" content="Secure staff login for Hair Clinic Pro management system.">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            ...
            inset: 0;
            background:
                radial-gradient(ellipse 60% 50% at 20% 10%, rgba(61,142,248,0.13) 0%, transparent 70%),
                radial-gradient(ellipse 50% 60% at 85% 80%, rgba(63,185,80,0.07) 0%, transparent 70%);
            pointer-events: none;
            z-index: 0;
        }
        ...
        .login-card {
            ...
            box-shadow:
                ...
                0 4px 16px rgba(61,142,248,0.08);
        ...
        .brand-icon {
            width: 2.6rem;
            height: 2.6rem;
            background: linear-gradient(135deg, #3d8ef8 0%, #1a65d6 100%);
            border-radius: 10px;
            display: grid;
            place-items: center;
            flex-shrink: 0;
            box-shadow: 0 4px 14px rgba(61,142,248,0.35);
        }
        ...
        .btn-login {
            ...
            box-shadow: 0 4px 14px rgba(61,142,248,0.3);
        }

        .btn-login:hover {
            background: var(--accent-h);
            box-shadow: 0 6px 20px rgba(61,142,248,0.4);
            transform: translateY(-1px);
        }

        .btn-login:active {
            transform: translateY(0) scale(0.98);
            box-shadow: 0 2px 8px rgba(61,142,248,0.2);
        }
        ...
        :root:not([data-theme="dark"]) .login-card {
            ...
            box-shadow: 0 24px 64px rgba(0,0,0,0.06), 0 4px 16px rgba(61,142,248,0.08);
        }
        :root:not([data-theme="dark"]) .input-wrap input {
            background: #ffffff;
            border: 1px solid rgba(0,0,0,0.15);
            color: #111111;
            box-shadow: 0 1px 2px rgba(0,0,0,0.05) inset;
        }
        :root:not([data-theme="dark"]) .input-wrap input:focus {
            background: #ffffff;
            border-color: var(--accent);
            box-shadow: 0 0 0 3px rgba(61,142,248,0.15);
        }
        ...
        :root:not([data-theme="dark"]) .brand-text strong {
            color: #111111;
        }
        :root:not([data-theme="dark"]) .login-heading h1 {
            color: #111111;
        }
        :root:not([data-theme="dark"]) body::after {
            opacity: 0.15;
        }
        :root:not([data-theme="dark"]) .strength-bar span {
            background: rgba(0,0,0,0.1);
        }
        :root:not([data-theme="dark"]) .btn-login {
            color: #ffffff;
        }
    </style>
...
<body>
    ...
    <main class="login-card" id="main-login" role="main">
        <!-- Brand -->
                <!-- Brand -->
        <div class="brand" aria-label="Hair Clinic Pro" style="justify-content: center; margin-bottom: 1.5rem;">
            <img src="https://static.vecteezy.com/system/resources/previews/025/379/740/non_2x/hair-follicle-logo-for-hair-care-clinic-design-concept-illustration-symbol-icon-vector.jpg" alt="Hair Clinic Pro Logo" style="width: 7.5rem; height: auto; object-fit: contain; border-radius: 8px;">
        </div>
