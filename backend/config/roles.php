...
return [
    ...
    'report_permissions' => [
        'Administrator' => ['users','patients','appointments','followups','consultations','medical_history','inventory','stock_in','stock_out','low_stock','expired','payments','finance','expenses','profit_loss','audit_logs','pharmacy','pharmacy_sales','prescriptions','top_medicines','inventory_movement','doctor_performance','laboratory','activity'],
        'Receptionist' => ['patients','appointments','payments'],
        'Doctor' => ['followups','consultations','medical_history'],
