...
<section class="patient-management-card">
    ...
    <div class="patient-list-grid patient-list-head" style="grid-template-columns: 1fr 1.5fr 1.2fr 1fr 1fr;">
        <span>Username</span>
        <span>Full Name</span>
        <span>Role</span>
        <span>Created</span>
    ...
    <?php foreach ($users as $user): ?>
        <div class="patient-list-grid patient-list-row" style="grid-template-columns: 1fr 1.5fr 1.2fr 1fr 1fr;">
