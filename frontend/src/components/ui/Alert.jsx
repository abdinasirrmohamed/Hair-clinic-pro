...
const VARIANTS = {
  ...
  success: { icon: CheckCircle,   color: '#7c3aed', bg: 'rgba(124,58,237,0.08)',   border: 'rgba(124,58,237,0.2)'   },
  info:    { icon: Info,          color: '#7c3aed', bg: 'rgba(124,58,237,0.06)',   border: 'rgba(124,58,237,0.15)'  },
};
